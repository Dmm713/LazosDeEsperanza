...
<body>
        ...
        <div class="container">
            <div class="header-content">
                ...
                <div class="new-user-container">
                    <a href="index.php?accion=misProyectosOrganizacion" class="btn btn-primary" style="margin-right: 80px;"><i class="fa-solid fa-left-long"></i></a>
                </div>
            </div>
        </div>
    </header>
    <div class="form-container">
        ...
        <?php endif; ?>
        <form id="editarProyectoForm" action="index.php?accion=editarProyecto&idProyecto=<?php echo $proyecto->getIdProyecto(); ?>" method="post" enctype="multipart/form-data">
